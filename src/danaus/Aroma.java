...
public class Aroma implements Comparable<Aroma> {
    ...
    public static int getMaxSteps(double in) {
        int steps;
        for (steps= 0; calculateIntensity(in, steps) > Aroma.MIN_AROMA_INTENSITY; steps++);
        return steps;
    }
    ...
    public @Override String toString() {
        return "{" + flower + ", " + String.format("%.2f", intensity) + "}";
    }
    ...
    public String toStringShort() {
        return flower.toStringShort() + ":" + String.format("%.1f", intensity);
    }
