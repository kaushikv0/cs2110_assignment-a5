...
public abstract class AbstractButterfly extends Entity {
     ...
     * butterfly must navigate to and collect all the flowers in <em>flowers<em>
     * in the order they are provided in order to successfully complete a 
     * simulation.
     * <br>
     * Good luck coding, and remember that <b>REAL</b> programmers program with
     * butterflies! See http://xkcd.com/378/
     * 
     * @param flowers A vector of flowers which the butterfly has to collect
     * in order.
     * @see danaus.AbstractButterfly#collect(Flower)
     */
	public abstract void run(List<Flower> flowers);
	 ...
	 * 
	 * @param f A flower.
	 * @param return The Location of f if f has been discovered. null 
	 * 		otherwise.
	 */
